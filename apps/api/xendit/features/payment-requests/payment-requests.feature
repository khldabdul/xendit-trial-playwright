...
Feature: Payment Requests
  ...
  @TC17_API @v3 @payment-requests @cards @smoke @failing @skip
  ...
  @TC17b_API @v3 @payment-requests @cards @negative @sandbox-restricted
  ...
  @TC18_API @v3 @payment-requests @cards @negative @failing @skip
  ...
  @TC19_API @v3 @payment-requests @cards @smoke @failing @skip
  ...
  @TC20_API @v3 @payment-requests @cards @negative @failing @skip
  ...
  @TC21_API @v3 @payment-requests @cards @failing @skip
  ...
  @TC22_API @v3 @payment-requests @cards @failing @skip
  ...
  @TC23_API @v3 @payment-requests @cards @negative @failing @skip
  ...
  @TC20q_API @v3 @payment-requests @qris @negative @failing @skip
